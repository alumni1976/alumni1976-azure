...
export async function render() {
  return getText("evaluation.renderHtml", `
    <section class="evaluation-page">
      ...
      <h2>Αξιολόγηση Εκδήλωσης &amp; Ιστοσελίδας</h2>

      <p>
        Η γνώμη σας μας βοηθά να βελτιώσουμε τόσο τις εκδηλώσεις της κοινότητας
        όσο και την ιστοσελίδα μας. Η συμπλήρωση διαρκεί περίπου 2 λεπτά.
      </p>

      <form id="evaluationForm" class="event-registration-form evaluation-form">
...
export async function afterRender() {
  ...
  form.addEventListener("submit", async event => {
    ...
    const allRatingFields = [...EVENT_RATING_FIELDS, ...WEBSITE_RATING_FIELDS];
    const missingRating = allRatingFields.find(field => !ratingValues[field.id]);
    ...
    try {
      ...
      statusMessage.innerHTML =
        getText("evaluation.successHtml", "✓ Ευχαριστούμε! Η αξιολόγησή σας καταχωρήθηκε με επιτυχία.");
